  ...
  describe('Google', () => {
    ...
    it('should return oauth signin url', async () => {
      ...
      expect(data.headers.Location).toMatch(
        /https:\/\/accounts\.google\.com\/o\/oauth2\/v2\/auth\?client_id=g-mock-id&redirect_uri=https:\/\/api-id\.execute-api\.eu-west-1\.amazonaws\.com\/dev\/authentication\/callback\/google&response_type=code&scope=openid profile email&state=.{64}/
      )
    })
